...
/**
 * Per-row admin actions for a shipping method: toggle active state,
 * edit link, and delete (with confirm).
 */
export function ShippingRowActions({ id, locale, isActive }: Props) {
  ...
  return (
    <div className="flex items-center justify-end gap-2">
      ...
      <Link
        href={`/${locale}/admin/shipping/${id}/edit`}
